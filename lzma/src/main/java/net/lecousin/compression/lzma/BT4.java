...
final class BT4 extends LZEncoder {
    ...
    BT4(int dictSize, int beforeSizeMin, int readAheadMax,
        ...
        super(dictSize, beforeSizeMin, readAheadMax, niceLen, matchLenMax, byteArrayCache);

        cyclicSize = dictSize + 1;
        lzPos = cyclicSize;

        hash = new Hash234(dictSize, intArrayCache);
        tree = intArrayCache.get(cyclicSize * 2, true);
