...
abstract class LZEncoder {
    ...
    LZEncoder(int dictSize, int extraSizeBefore, int extraSizeAfter,
              int niceLen, int matchLenMax, ByteArrayCache arrayCache) {
     ...
     */
    public int fillWindow(ByteBuffer buffer) {
        assert !finishing;
    ...
    public void copyUncompressedSync(IO.Writable.Buffered output, int backward, int len)
    throws IOException {
